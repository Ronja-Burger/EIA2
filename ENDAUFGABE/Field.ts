namespace farm {
    ...
    export class Field {
        ...
        constructor(_market: Market, _plants: object) {
        ...
        grow(_tick: number): void {
            ...
            if (this.waterNeed == this.waterStock && this.dungNeed == this.dungStock && !this.pestAttack) { 
                if (this.plant.growthTime > this.growthProzss) { // if growthProzess is smaller tha growthTime ...
                    ...
                    if (this.waterNeedTime >= this.plant.waterNeedTime) { // if waterNeedTime is bigger than the waterNeedTime from this plant ...
                     ...
                     //Icon auftauchen lassen im Zusatzfeld!
                    if (this.dungNeedTime >= this.plant.dungNeedTime) { // if dungNeedTime is bigger than the dungNeedTime from this plant ... 
